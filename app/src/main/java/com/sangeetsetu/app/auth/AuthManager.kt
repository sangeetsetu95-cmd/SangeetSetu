package com.sangeetsetu.app.auth
...
class AuthManager(private val context: Activity) {
    ...
    fun signUpWithEmail(name: String, email: String, password: String, callback: AuthCallback) {
        try {
            Log.d("BackendAuth", "Attempting signup for $email")
                        ...
                        if (user != null) {
                            ...
                            db.collection("users").document(user.uid).get()
                                ...
                                .addOnFailureListener { e ->
                                    ...
                                    // Fallback to success if it's just a read error, but log it
                                    callback.onAuthSuccess()
                                }
                        } else {
